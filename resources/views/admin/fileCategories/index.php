...
<div class="page-header">
  <a class="btn float-right btn-success" href="<?= $url('admin/file-categories/new') ?>">添加栏目</a>
...
<script id="table-actions" type="text/html">
  <div class="action-buttons">
    ...
    <a class="text-danger delete-record" href="javascript:;"
      data-href="<%= $.url('admin/file-categories/destroy', {id: id}) %>" title="删除">
...
<?= $block->js() ?>
<script>
  require(['plugins/category/js/admin/categories', 'plugins/admin/js/form', 'plugins/admin/js/data-table'], function (categoryUtil, form) {
